    ...
    <div class="projects">
        <article class="post">
            ...
            <div class="post-content">
                <h2 class="title">Apple Video lancé en avril aux États-Unis?</h2>
                ...
                <div class="the-content">
                    ...
                    <div class="post-footer">
                        ...
                        <div class="post-tags"><a href="#" rel="tag">beautifuly</a><a href="#" rel="tag">kendythemes</a></div>
                    </div>
                </div>
                <div id="comments">
                        ...
                        <ul class="comment-list">
                            <li class="comment">
                                ...
                                <ul class="children">
                                    <li class="comment">
                                        <div class="comment-body">
                                            <div class="comment-avatar image" style="background-image: url(../public/images/Front/avatar-150px.jpg);">
                                                <img alt="avatar" src="../public/images/Front/avatar-150px.jpg">
                                            </div>
                                            <div class="comment-context">
                                                <div class="comment-head">
